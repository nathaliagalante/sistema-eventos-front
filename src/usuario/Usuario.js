        ...
        return (
            <div className="row mt-5 pt-4">
                ...
                <div className="row mt-2">
                    <div className="col-4">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sexo" id="sexoMasc" value="Masculino" defaultChecked={!this.state.sexobool}  onChange={this.txtSexo_change}></input>
                            <label class="form-check-label" for="sexoMasc">Masculino</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sexo" id="sexoFem" value="Feminino" defaultChecked={this.state.sexobool} onChange={this.txtSexo_change}></input>
                            <label class="form-check-label" for="sexoFem">Feminino</label>
                        </div>
                    </div>    
                </div>
