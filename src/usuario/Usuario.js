...
export default class Usuario extends Component {
    ...
    /* ----- ALTERAR USUÁRIO ----- */
    alterarNovo = (usuario) => {
        var dataConvertida = new Date(usuario.dataNascimento);
        dataConvertida.setDate(dataConvertida.getDate() + 1)
        this.setState({ alterando: true, id: usuario.id, nomeCompleto: usuario.nomeCompleto, sexo: usuario.sexo, endereco: usuario.endereco, login: usuario.login, senha: usuario.senha, dataNascimento: dataConvertida, nivelAcesso: usuario.nivelAcesso, telefones: usuario.telefones, parentes: usuario.parentes, foto: usuario.foto })
    ...
    verDetalhes = (usuario) => {
        var dataConvertida = new Date(usuario.dataNascimento);
        dataConvertida.setDate(dataConvertida.getDate() + 1)
        this.setState({ analisando: true, id: usuario.id, nomeCompleto: usuario.nomeCompleto, sexo: usuario.sexo, endereco: usuario.endereco, login: usuario.login, senha: usuario.senha, dataNascimento: dataConvertida, nivelAcesso: usuario.nivelAcesso, telefones: usuario.telefones, parentes: usuario.parentes, foto: usuario.foto })
        this.preencherTelefones(usuario.id)
        this.preencherParentes(usuario.id)
    }
        ...
        return (
            <div className="container">
                <div className="row mt-5 pt-4 g-3">
                    ...
                    <div className="mt-3 mb-3 col-md-2">
                            ...
                            <tbody>
                                {this.state.usuarios && this.state.usuarios.map(usuario => {
                                    ...
                                    return <tr key={usuario.id}>
                                        ...
                                        <td>{((dataConvertida.getDate())) + "/" + ((dataConvertida.getMonth() + 1)) + "/" + dataConvertida.getFullYear()}</td>
